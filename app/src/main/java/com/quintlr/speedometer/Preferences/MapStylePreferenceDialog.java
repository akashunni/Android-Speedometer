...
public class MapStylePreferenceDialog extends DialogFragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mapStylePreference = PreferenceManager.getDefaultSharedPreferences(getActivity());
        mapStyleNames = getResources().getStringArray(R.array.map_style_names);
        mapStyleValues = getResources().getIntArray(R.array.map_style_values);
